...
export const getDefaultState = (): AuthState => {
    const rawAccess = localStorage.getItem('mainsail_moonraker_access_token')
    const rawRefresh = localStorage.getItem('mainsail_moonraker_refresh_token')
    const rawUser = localStorage.getItem('mainsail_moonraker_username')
