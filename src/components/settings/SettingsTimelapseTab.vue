...
export default class SettingsTimelapseTab extends Mixins(BaseMixin) {
    ...
    set stream_delay_compensation(newVal) {
        this.$store.dispatch('server/timelapse/saveSetting', {
            stream_delay_compensation: newVal,
        })
    }
