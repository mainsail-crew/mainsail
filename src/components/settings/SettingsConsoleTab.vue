...
export default class SettingsConsoleTab extends Mixins(BaseMixin) {
    ...
    set consoleDirection(newVal) {
        this.$store.dispatch('gui/console/saveSetting', {
            name: 'direction',
            value: newVal,
        })
    }
    ...
    toggleFilter(filter: any) {
        ...
        this.$store.dispatch('gui/console/filterUpdate', {
            id: filter.id,
            values,
        })
    }
    ...
    saveFilter() {
        if (this.form.valid) {
            ...
            if (this.form.id)
                ...
                this.$store.dispatch('gui/console/filterStore', {
                    values: filter,
                })
