...
export default class SettingsWebcamsTab extends Mixins(BaseMixin) {
    ...
    get iconItems() {
        return [
            {
                value: 'mdi-printer-3d',
                text: this.$t('Settings.WebcamsTab.IconPrinter'),
            },
            {
                value: 'mdi-printer-3d-nozzle',
                text: this.$t('Settings.WebcamsTab.IconNozzle'),
            },
            {
                value: 'mdi-radiator-disabled',
                text: this.$t('Settings.WebcamsTab.IconBed'),
            },
            {
                value: 'mdi-webcam',
                text: this.$t('Settings.WebcamsTab.IconCam'),
            },
            {
                value: 'mdi-album',
                text: this.$t('Settings.WebcamsTab.IconFilament'),
            },
            {
                value: 'mdi-door',
                text: this.$t('Settings.WebcamsTab.IconDoor'),
            },
            {
                value: 'mdi-raspberry-pi',
                text: this.$t('Settings.WebcamsTab.IconMcu'),
            },
            {
                value: 'mdi-campfire',
                text: this.$t('Settings.WebcamsTab.IconHot'),
            },
        ]
    }
    ...
    get serviceItems() {
        return [
            {
                value: 'mjpegstreamer',
                text: this.$t('Settings.WebcamsTab.Mjpegstreamer'),
            },
            {
                value: 'mjpegstreamer-adaptive',
                text: this.$t('Settings.WebcamsTab.MjpegstreamerAdaptive'),
            },
            {
                value: 'uv4l-mjpeg',
                text: this.$t('Settings.WebcamsTab.Uv4lMjpeg'),
            },
            {
                value: 'ipstream',
                text: this.$t('Settings.WebcamsTab.Ipstream'),
            },
        ]
    }
    ...
    saveWebcam() {
        if (this.form.valid) {
            ...
            if (this.form.id !== null)
                this.$store.dispatch('gui/webcams/update', {
                    id: this.form.id,
                    values: values,
                })
