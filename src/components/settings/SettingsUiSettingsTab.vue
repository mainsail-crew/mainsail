...
export default class SettingsUiSettingsTab extends Mixins(BaseMixin) {
    ...
    set boolBigThumbnail(newVal) {
        this.$store.dispatch('gui/saveSetting', {
            name: 'uiSettings.boolBigThumbnail',
            value: newVal,
        })
    }
    ...
    set boolWebcamInNavigation(newVal) {
        this.$store.dispatch('gui/saveSetting', {
            name: 'uiSettings.boolWebcamNavi',
            value: newVal,
        })
    }
    ...
    set displayCancelPrint(newVal) {
        this.$store.dispatch('gui/saveSetting', {
            name: 'uiSettings.displayCancelPrint',
            value: newVal,
        })
    }
    ...
    set displayZOffsetStandby(newVal) {
        this.$store.dispatch('gui/saveSetting', {
            name: 'uiSettings.displayZOffsetStandby',
            value: newVal,
        })
    }
    ...
    set confirmOnEmergencyStop(newVal) {
        this.$store.dispatch('gui/saveSetting', {
            name: 'uiSettings.confirmOnEmergencyStop',
            value: newVal,
        })
    }
    ...
    set lockSliders(newVal) {
        this.$store.dispatch('gui/saveSetting', {
            name: 'uiSettings.lockSlidersOnTouchDevices',
            value: newVal,
        })
    }
    ...
    set lockSlidersDelay(newVal) {
        newVal >= 0
            ? this.$store.dispatch('gui/saveSetting', {
                  name: 'uiSettings.lockSlidersDelay',
                  value: newVal,
              })
            : {}
    }
    ...
    set navigationStyleSetting(newVal) {
        this.$store.dispatch('gui/saveSetting', {
            name: 'uiSettings.navigationStyle',
            value: newVal,
        })
    }
