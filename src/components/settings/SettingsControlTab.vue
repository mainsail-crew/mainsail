                    ...
                    <settings-row :title="$t('Settings.ControlTab.SpeedXY')">
                        <v-text-field
                            ...
                            :rules="[
                                (v) =>
                                    v > 0 ||
                                    $t('Settings.ControlTab.ValueGreaterThan', {
                                        value: '0',
                                    }),
                            ]"
                            outlined
                    ...
                    <settings-row :title="$t('Settings.ControlTab.MoveDistancesEInMm')" :mobile-second-row="true">
                        <v-combobox
                            ...
                            :rules="[
                                (v) =>
                                    v.length > 0 ||
                                    $t('Settings.ControlTab.MinimumValues', {
                                        minimum: '1',
                                    }),
                                (v) =>
                                    v.length <= 5 ||
...
export default class SettingsControlTab extends Mixins(BaseMixin) {
    ...
    set feedamountsE(newVal) {
        ...
        this.$store.dispatch('gui/saveSetting', {
            name: 'control.extruder.feedamounts',
            value: amounts,
        })
    }
    ...
    set feedratesE(newVal) {
        ...
        this.$store.dispatch('gui/saveSetting', {
            name: 'control.extruder.feedrates',
            value: rates,
        })
    }
