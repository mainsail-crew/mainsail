                ...
                <v-toolbar-title>
                    <span class="subheading">
                        ...
                        <template v-if="application.substr(0, 8) === 'recover_' && !complete">
                            {{
                                $t('App.UpdateDialog.Recovering', {
                                    software: application.substr(8),
                                })
                            }}
                        </template>
                        <template v-else-if="application.substr(0, 8) === 'recover_'">
                            {{
                                $t('App.UpdateDialog.RecoveringDone', {
                                    software: application.substr(8),
                                })
                            }}
                        </template>
                        ...
                        <template v-else>
                            {{
                                $t('App.UpdateDialog.UpdatingDone', {
                                    software: application,
                                })
                            }}
                        </template>
