                ...
                <v-card-text class="mt-3">
                    ...
                    <v-row v-if="showCorsInfo">
                        <v-col>
                            ...
                            <p class="text-center">
                                {{
                                    $t('SelectPrinterDialog.RememberToAdd', {
                                        cors: currentUrl,
                                    })
                                }}
                            </p>
...
export default class TheSelectPrinterDialog extends Mixins(BaseMixin) {
    ...
    get panelTitle() {
        if (this.dialogAddPrinter.bool) return this.$t('SelectPrinterDialog.AddPrinter')
            ...
            return this.$t('SelectPrinterDialog.Connecting', {
                host: this.formatHostname,
            })
        else if (this.connectingFailed)
            return this.$t('SelectPrinterDialog.ConnectionFailed', {
                host: this.formatHostname,
            })
