                    ...
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-content style="padding-top: 0em">
                            <div v-for="(tool, toolName) in toolData" style="margin-left: 15px">
                                ...
                                <div
                                    v-if="tool.lane_loaded !== ''"
                                    style="margin-right: 10px; float: right; margin-top: 0px">
                            ...
                            <div class="spool-container">
                                <div
                                    ...
                                    <div
                                        ...
                                        <FilamentReelIcon v-if="spool.prep" :color="spool.color" style="float: left" />
                                        <FilamentReelIcon v-else :color="'transparent'" style="float: left" />
                                    </div>
                                    <div class="spool-header">
                                        <span
                                            style="color: red"
                                            v-if="!spool.load && !spool.prep && !spool.tool_loaded">
