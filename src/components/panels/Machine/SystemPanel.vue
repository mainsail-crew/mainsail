                            ...
                            <template v-if="mcu.tempSensor">
                                ...
                                >
                                    <v-tooltip top>
                                        ...
                                        <span>
                                            max:
                                            {{ mcu.tempSensor.measured_max_temp }}°C<br />
                                            min:
                                            {{ mcu.tempSensor.measured_min_temp }}°C
                                        </span>
                                    </v-tooltip>
                                </template>
                                <template v-else>
                                    Temp:
                                    {{ mcu.tempSensor.temperature + '°C' }}
                                </template>
                            </template>
                        </v-col>
                    ...
                    <v-row class="py-0">
                        <v-col class="pl-6">
                            ...
                            <span v-if="hostStats.release_info && hostStats.release_info.name !== '0.'"
                                >{{ $t('Machine.SystemPanel.Distro') }}:
                                {{ hostStats.release_info.name }}
                            ...
                            <template v-if="hostStats.tempSensor">
                                ...
                                >
                                    <v-tooltip top>
                                        ...
                                        <span>
                                            max:
                                            {{ hostStats.tempSensor.measured_max_temp }}°C<br />
                                            min:
                                            {{ hostStats.tempSensor.measured_min_temp }}°C
                                        </span>
                                    </v-tooltip>
                                </template>
                                <template v-else>
                                    Temp:
                                    {{ hostStats.tempSensor.temperature + '°C' }}
                                </template>
                            </template>
                        </v-col>
                        <v-col class="px-6 col-auto d-flex justify-end align-center">
