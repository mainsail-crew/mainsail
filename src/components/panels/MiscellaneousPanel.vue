...
<template>
    <div>
        <v-card class="mt-6" v-if="['printing', 'paused', 'standby'].includes(printer_state)">
            ...
            <v-divider></v-divider>
            <tool-slider label="Extrusion factor" new-dynamic :editable="true" :target="extrude_factor" :max="1000" :multi="100" :step="1" :dynamic-range="true" command="M221" attribute-name="S" ></tool-slider>
        </v-card>
