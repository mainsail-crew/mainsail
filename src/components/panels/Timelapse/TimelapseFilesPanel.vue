        ...
        <v-dialog v-model="dialogDeleteDirectory.show" max-width="400">
            ...
            >
                ...
                <v-card-text>
                    <p class="mb-0">
                        {{
                            $t('Timelapse.DeleteDirectoryQuestion', {
                    ...
                    <v-row>
                        <v-col class="pb-0">
                            <video :src="hostUrl + 'server/files/' + videoDialogFilename" controls style="width: 100%">
                                ...
                                <a :href="hostUrl + 'server/files/' + videoDialogFilename">download it</a>
                    ...
                    <v-row>
                        <v-col class="text-center">
                            <v-btn
                                text
                                color="primary"
                                :href="hostUrl + 'server/files/' + videoDialogFilename"
                                target="_blank"
...
export default class TimelapseFilesPanel extends Mixins(BaseMixin) {
    ...
    get headers() {
        return [
            ...
            {
                text: this.$t('Timelapse.Filesize'),
                value: 'size',
                align: 'right',
                configable: true,
                visible: true,
    ...
    set countPerPage(newVal) {
        this.$store.dispatch('gui/saveSetting', {
            name: 'view.timelapse.countPerPage',
            value: newVal,
        })
    }
    ...
    set currentPath(newVal) {
        this.$store.dispatch('gui/saveSettingWithoutUpload', {
            name: 'view.timelapse.currentPath',
            value: newVal,
        })
    }
