<template>
    <v-row v-if="existGcodesRootDirectory">
        <v-col :class="showJobQueue ? 'v-col-12 v-col-md-8 pt-0 pt-md-3 order-1 order-md-0' : 'v-col-12'">
            <gcodefiles-panel></gcodefiles-panel>
        </v-col>
        <v-col v-if="showJobQueue" class="v-col-12 v-col-md-4 pb-0 pb-sm-3 order-0 order-md-1">
